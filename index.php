...
<main class="container">
    <section class="promo">
        ...
        <ul class="promo__list">
            ...
            <?php foreach ($categories as $indexCategory => $categoryName): ?>
            <li class="promo__item promo__item--<?=$categoryName;?>">
    ...
    <section class="lots">
        ...
        <ul class="lots__list">
            ...
            <?php foreach ($catalog as $indexCategory => $categoryName): ?>
            <li class="lots__item lot">
                <div class="lot__image">
                    <img src="<?=$categoryName["image"];?>" width="350" height="260" alt="">
                </div>
                <div class="lot__info">
                    <span class="lot__category"><?=$categoryName["category"];?></span>
                    <h3 class="lot__title"><a class="text-link" href="pages/lot.html"><?=$categoryName["title"];?></a></h3>
                    <div class="lot__state">
                        <div class="lot__rate">
                            <span class="lot__amount">Стартовая цена</span>
                            <span class="lot__cost"><?=$categoryName["price"];?><b class="rub">р</b></span>
                        </div>
